...
숫자 없이 실행하면 해당 자료구조 그룹의 전체 문제를 한 번에 테스트합니다.
- `./test list` 는 Linked List 전체 문제를 테스트합니다.
- `./test queue` 는 Stack and Queue 전체 문제를 테스트합니다.
- `./test tree` 는 Binary Tree 전체 문제를 테스트합니다.
- `./test bst` 는 Binary Search Tree 전체 문제를 테스트합니다.
